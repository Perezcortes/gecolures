...
// Datos de prueba: Mezcla de capturas de Instagram y Facebook con tus links de Cloudinary
...
export default function GecoNation() {
  ...
  useEffect(() => {
    ...
    }, 3000); // 3000 ms = Pasa cada 3 segundos
  ...
  return (
    <section className="py-20 bg-white dark:bg-[#0e0e0e] overflow-hidden">
      ...
      {/* CARRUSEL DE FOTOS MIXTAS (Con el scrollRef para el auto-play) */}
      <div 
        ref={scrollRef}
